...
/*Question:- Sort the stack using recursion without using any Java collection API- NTT DATA*/

public class SortStackUsingRecursion {
	
	/*Insert the given key in the sorted stack while maintaining its sorted order. This is similar to recursive Insertion 
	sort routine*/
    public static void sortedInsert(Stack<Integer> stack, int key)
    {
       /* Base case: if the stack is empty or the key is greater than all elements in the stack*/
        ...
        if (stack.isEmpty() || key > stack.peek())
        {
         ...
         /*We reach here when the key is smaller than the top element Remove the top element*/
        int top = stack.pop();
    ...
    {
        List<Integer> list = Arrays.asList(5, -2, 9, -7, 3, 12 ,3 ,8 ,21 );
